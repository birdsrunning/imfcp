...
export default function CtaSection() {
  return (
    <div className="relative rounded-2xl p-[1px] bg-gradient-to-br from-white/50 via-white/10 to-white/40 shadow-[0_0_40px_rgba(255,255,255,0.08)] max-w-7xl lg:mx-auto mx-6 my-12">
      <section className="relative h-fit rounded-2xl overflow-hidden px-6 py-20 md:px-14 md:py-28">
        {/* Background video with fallback poster */}
        <video
          className="absolute inset-0 h-full w-full object-cover filter saturate-110 contrast-105 motion-reduce:hidden"
          autoPlay
          loop
          muted
          playsInline
        ...
        {/* Reduced overlay for readability */}
        {/* <div
          className="
            absolute inset-0
            bg-[radial-gradient(140%_140%_at_85%_85%,rgba(255,106,61,0.35)_0%,rgba(255,106,61,0.2)_30%,rgba(0,0,0,0.3)_70%),linear-gradient(135deg,rgba(20,11,10,0.45)_0%,rgba(74,31,22,0.35)_40%,rgba(0,0,0,0.25)_100%)]
          "
        /> */}

        {/* Decorative layer */}
        <div className="pointer-events-none absolute inset-0 opacity-30">
          {/* svg patterns / floating tags could go here */}
        </div>

        {/* Content */}
        <div className="relative z-10 mx-auto max-w-3xl text-center flex flex-col items-center gap-32">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight text-white">
            AI Images, Done Once—For Everything You’ll Ever Build.
          </h2>
